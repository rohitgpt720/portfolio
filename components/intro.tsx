    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-24 w-24 rounded-full object-cover border-[0.1rem] border-slate-300 shadow-xl"
            />
          </motion.div>
      ...
      >
        ...
        <a
          ...
          href="https://drive.google.com/file/d/1wDscSDNTntPlPFcLuclhBnCcVk4acu52/view?usp=drive_link"
          target="_blank"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/rohitfrontdev/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/rohitgpt720"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
